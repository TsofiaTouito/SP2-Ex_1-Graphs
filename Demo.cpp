...
int main()
{
    ...
    g1 /= -2;
    ariel::Graph g10 = g1 * g2; // Multiply the two graphs together.
    cout<<g10;           // Should print the multiplication of the matrices of g1 and g2: [1, 0, 2], [1, 3, 1], [1, 0, 2]
    ...
    vector<vector<int>> graph7 = {
        ...
        {1, 0, 0, 1, 0}};
    ariel::Graph g5;
    g5.loadGraph(graph7); // Load the graph to the object.
    try
    {
